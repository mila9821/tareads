...
import com.example.menuprincipal.MainActivity;
...
public class AgenciasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AgenciaAdaptadores(this, getDatos());
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AgenciaItems.agenciasItems item = (AgenciaItems.agenciasItems) parent.getItemAtPosition(position);
                Intent intent = new Intent(getApplicationContext(), InfoAgencia.class);
    ...
    private ArrayList<AgenciaItems.agenciasItems> getDatos() {
        return AgenciaItems.ArregloLista();
    }
