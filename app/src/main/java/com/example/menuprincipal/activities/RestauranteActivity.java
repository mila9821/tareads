...
import com.example.menuprincipal.InfoRestaurant;
...
import com.example.menuprincipal.adaptadores.RestaurantsAdaptadores;
import com.example.menuprincipal.adaptadores.RestaurantsItems;

import java.util.ArrayList;

public class RestauranteActivity extends AppCompatActivity {
    RestaurantsAdaptadores adapter;
    ListView lista;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RestaurantsAdaptadores(this, getDatos());
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                RestaurantsItems.restaurantesItems item = (RestaurantsItems.restaurantesItems) parent.getItemAtPosition(position);
                Intent intent = new Intent(getApplicationContext(), InfoRestaurant.class);
    ...
    private ArrayList<RestaurantsItems.restaurantesItems> getDatos() {
        return RestaurantsItems.ArregloLista();
    }
